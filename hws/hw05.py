class VendingMachine:
    ...
    def vend(self):
        if self.balance >= self.price and self.stock > 0:
            ...
            self.stock -= 1
            if self.balance > 0:
                l = 'Here is your {0} and ${1} change.'.format(self.name, self.balance)
                self.balance = 0
                return l
...
def is_bst(t):
    ...
    def bst_min(t):
        if t.is_leaf():
            return t.label
        if len(t.branches) == 1:
            if t.branches[0] == t.label:
                return bst_min(t.branches[0])
            if min(t.label, t.branches[0].label) == t.label:
                return t.label
        return bst_min(t.branches[0])
    ...
    def bst_max(t):
        ...
        if len(t.branches) == 1:
            ...
            if max(t.label, t.branches[0].label) == t.label:
                return t.label
        if len(t.branches) == 2:
